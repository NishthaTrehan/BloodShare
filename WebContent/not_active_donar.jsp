...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
           ...
           <div id="admin_dashboard"></div>
                <div class="col-sm-9">
                    <h3 class="mainhead3"><i class="fa fa-users" aria-hidden="true"></i> Not Active Donars</h3>
                    <hr></hr>
   ...
   try {
        ...
        ResultSet r = smt.executeQuery("select * from donar_reg where(activate='deactivate');");
 ...
 %>
                            ...
                            <tr>
                                ...
                                <td><form method="post" action="activate_donar.jsp" style="display:inline;">
                                        <input type="text" name="nonactivename" value="<%  out.print(name); %>" class="hidden" >
                                        <input type="submit" class="btn" value="Click To Activate">
                                </form>
                                </td>
                            </tr> 
                        </tbody>
